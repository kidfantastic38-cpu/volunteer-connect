        ...
        <div className="flex justify-between gap-1.5 sm:gap-2" onPaste={onPaste}>
          {digits.map((d, i) => (
            <input
              ...
              className={cn(
                "h-12 min-w-0 flex-1 rounded-xl border bg-background text-center font-display text-xl font-semibold text-foreground outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 sm:h-14 sm:text-2xl",
